...
<div class="css-2025">
	...
	<section id="sponsors" class="pt-5 mx-auto">
		...
		<p class="white pb-1">
			We held the first Svelte conference on April 26, 2019. It gathered over 1000 highly
			enthusiastic developers from across the globe. Since then, we've hosted and organised nine
			more events. Each time, the number of attendees dramatically increases. In contrast to most
			other events we take pride in keeping it joyfli and fun, much like how people feel when they
			decide to use Svelte.
		</p>
		<p class="white pb-3">
		...
		<div class="text-center">
			<div class="btn-group">
				<a class="btn --lg m-0 p-0" href="mailto:sponsors@sveltesummit.com">
					Become a sponsor
				</a>
			</div>
		</div>
		...
		<p class="pb-1 white">
			...
			jobs if they find a new one where they can use it. As you can see in the screenshots below,
			Svelte topped the charts for most exciting and most loved framework in a couple of surveys
			this year.
		</p>
		...
		<div id="sponsor-podcast" class="sponsor-package pt-5 pb-3 mt-5 text-center">
			...
			<p>
				...
				company in the minds of our audience.
			</p>
			<ul>
				<li>
					A 30 second pre-roll and mid-roll ad in the <a
						...
						target="_blank"
						class="underline">Svelte Radio Podcast</a
