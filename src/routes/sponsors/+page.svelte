...
<section id="sponsors" class="pt-5 mx-auto">
	...
	<div id="sponsor-gold" class="sponsor-package pt-5 pb-3 mt-5 text-center">
		...
		<p>
			You like Svelte a lot. And you want there to be more conferences. This is the package for you.
			You'll also be eternalised in the separate videos that will be uploaded after the event on our
			YouTube channel.
		</p>
		<ul>
	...
	<div id="sponsor-podcast" class="sponsor-package pt-5 pb-3 mt-5 text-center">
		...
		<p>
			You think the Svelte community is awesome and want to make sure it thrives. This is a package
			that is designed to give you an opportunity to repeatedly keep the name of your company in the
	...
	<div id="sponsor-other" class="sponsor-package pt-5 pb-3 mt-5 text-center">
		...
		<p>
			...
			definitely open to modifying already existing ones or creating completely custom made packages
			just for you. Reach out to us and we'll figure something out!
		</p>
		<ul>
